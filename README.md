...
Meu nome é Diego Parreira, sou brasileiro (🇧🇷). Estudante de Sistemas de Informação na UNICAMP desde 2015(🤖). Sou natural de Campinas e vivo em Limeira desde 2015. Sou um aspirante à desenvolvedor full stack e minha linguagem principal de programação é o Javascript devido ao seu poder e adaptabilidade a múltíplas plataformas, além disso, eu já trabalhei em projetos com C, Java e Java Android.
